classdef ModelVersion < oms.abstract.OpenMindsSchema

	properties (Constant, Hidden)
		required = {'accessibility', 'fullDocumentation', 'versionInnovation', 'releaseDate', 'shortName', 'versionIdentifier', 'funding', 'format', 'license'}
	end

	properties (Constant)
		x0x5F_type = 'https://openminds.ebrains.eu/core/ModelVersion'
		description_ = 'Structured information on a computational model (version level).'
	end
	...
	properties
		...
		outputData             oms.abstract.OpenMindsSchema % N/A
	...
	methods
		...
		function obj = ModelVersion(accessibility, fullDocumentation, versionInnovation, releaseDate, shortName, versionIdentifier, funding, format, license, varargin)
