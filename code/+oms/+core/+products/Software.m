classdef Software < oms.abstract.OpenMindsSchema
	...
	properties (Constant)
		x0x5F_type = 'https://openminds.ebrains.eu/core/Software'
		description_ = 'Structured information on a software tool (concept level).'
	end
	...
	methods
		...
		function obj = Software(fullName, developer, shortName, hasVersion, description, varargin)
